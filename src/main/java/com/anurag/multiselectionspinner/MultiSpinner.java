...
public class MultiSpinner extends AppCompatTextView {
    ...
    public void setAdapterWithImage(Context context, List<String> imageURLList, List<String> spinnerContentList, MultiSelectionSpinnerDialog.OnMultiSpinnerSelectionListener onMultiSpinnerSelectionListener, String title) {

        MultiSelectionSpinnerDialog multiSelectionSpinnerDialog = new MultiSelectionSpinnerDialog(context, title);
    ...
    public void setAdapterWithOutImage(Context context, List<String> spinnerContentList, MultiSelectionSpinnerDialog.OnMultiSpinnerSelectionListener onMultiSpinnerSelectionListener, String title) {
